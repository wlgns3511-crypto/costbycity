...
export default function TermsPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-emerald-700 mb-6">Terms of Service</h1>
      <p className="text-sm text-slate-500 mb-8">Last updated: March 25, 2026</p>

      <p>
        Welcome to CostByCity. By accessing or using our website at costbycity.com, you agree to be bound by these
      ...
      <p>
        CostByCity provides cost of living data, city comparisons, and related economic information for informational
        and educational purposes only. You may use the website for personal, non-commercial purposes. The information
        provided should not be the sole basis for relocation or financial decisions.
      </p>
      ...
      <p>
        ...
        sourced from publicly available government datasets, including the Bureau of Economic Analysis. Users should
      ...
      <p>
        The content, design, and layout of this website are the property of CostByCity and are protected by copyright
      ...
      <p>
        To the fullest extent permitted by law, CostByCity shall not be liable for any indirect, incidental, special,
      ...
      <p>
        ...
        <a href="/contact" className="text-emerald-600 hover:underline">contact page</a>.
      </p>
    </article>
  );
}
