...
export default function DisclaimerPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-emerald-700 mb-6">Disclaimer</h1>
      ...
      <p>
        The information provided on CostByCity is for general informational and educational purposes only. While we
      ...
      <p>
        Data displayed on CostByCity is sourced from publicly available databases and third-party sources. While we
      ...
      <p>
        CostByCity displays third-party advertisements through Google AdSense and other ad networks. These advertisements
        are provided by third parties and do not imply endorsement by CostByCity. We are not responsible for the content
      ...
      <p>
        In no event shall CostByCity, its owners, operators, or contributors be liable for any direct, indirect,
