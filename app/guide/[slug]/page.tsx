...
// dynamicParams=false (2026-04-23): unknown guide slugs return real HTTP 404.
// All guides prebuilt. Avoids Next.js 16 soft-404.
...
export default async function GuidePage({ params }: Props) {
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      {guide.faqs && guide.faqs.length > 0 && <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(guide.faqs)) }} />}
      <script
      ...
      <TrustBlock sources={[{name:"BEA Regional Price Parities",url:"https://www.bea.gov/data/prices-inflation/regional-price-parities-state-and-metro-area"},{name:"Census ACS",url:"https://www.census.gov/programs-surveys/acs"},{name:"BLS CPI",url:"https://www.bls.gov/cpi/"}]} updated="BEA RPP 2023" />
