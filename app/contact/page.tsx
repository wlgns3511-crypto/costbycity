...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with the CostByCity team.",
  alternates: { canonical: "/contact/" },
  openGraph: { title: "Contact Us", description: "Get in touch with the CostByCity team.", url: "/contact/" },
};
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-6">
        ...
        <p className="mb-2">
          <strong>Email:</strong>{" "}
          <a href="mailto:contact@costbycity.com" className="text-emerald-600 hover:underline">
            contact@costbycity.com
          </a>
        </p>
      ...
      <p>
        Your feedback helps us improve CostByCity for everyone. If you notice any data discrepancies or have ideas
