    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": `https://costbycity.com/blog/${slug}/`,
            },
          }),
        }}
      />
      ...
      <header className="mb-8">
        ...
        <div className="text-xs text-slate-400 flex items-center gap-3">
          ...
          <span>· CostByCity Editorial Team</span>
        </div>
      </header>
        ...
        <section className="mt-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {suggestions.map((p) => (
              ...
              >
                <span className="text-xs text-emerald-600">{p.category}</span>
                <h3 className="text-sm font-semibold text-slate-900 group-hover:text-emerald-700 mt-1 leading-snug">
                  {p.title}
                </h3>
