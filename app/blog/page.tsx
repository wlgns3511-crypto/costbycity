...
export const metadata: Metadata = {
  title: "Cost of Living Guides & Resources",
  description:
    "Expert guides on comparing city costs, housing affordability, relocation decisions, and making the most of your money wherever you live.",
  ...
  return (
    <>
      <h1 className="text-3xl font-bold text-slate-900 mb-2">
        Cost of Living Guides &amp; Resources
      </h1>
      <p className="text-slate-600 mb-8">
        Expert articles on comparing cities, housing costs, relocation math,
        and stretching your salary further in any market.
      </p>
