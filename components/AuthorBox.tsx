  ...
  return (
    <div className="mt-10 p-5 bg-slate-50 border border-slate-200 rounded-xl">
      ...
      <p className="text-xs text-slate-600 leading-relaxed mb-3">
        CostByCity is maintained by an editorial workflow that audits public data sources and verifies dates, values, and methodology on every page. We publish as an organization — no individual bylines — and disclose our data vintage and review dates openly.
      </p>
